{% set configs =[
    ...
    {
        "table": "walmart.silver_tech.order_t",
        "columns":"""o.order_id,
                        o.store_id,
                        o.order_timestamp,
                        o.payment_method,
    ...
    {
        "table": "walmart.silver_tech.customer_t",
    ...
    {
        "table": "walmart.silver_tech.order_items_t",
    ...
    {
        "table": "walmart.silver_tech.product_t",
    ...
    {
        "table": "walmart.silver_tech.employee_t",
    ...
    {
        "table": "walmart.silver_tech.Store_t",
